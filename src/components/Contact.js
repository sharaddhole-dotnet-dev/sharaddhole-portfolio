...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formsubmit.co/sharaddhole2021@gmail.com', {
        method: 'POST',
        headers: {
          ...
          <div className="flex-1 min-w-[280px]">
            ...
            <div className="mt-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:sharaddhole2021@gmail.com" className="hover:text-primary transition-colors">
                  sharaddhole2021@gmail.com
                </a>
              </div>
              <div className="flex items-center gap-3">
                <FaLinkedin className="text-primary" />
                <a href="https://www.linkedin.com/in/sharaddhole27/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  linkedin.com/in/sharaddhole27
                </a>
              </div>
